 ...
 *
 * This file is really only responsible for making sure the FUSE library
 * is loaded with the correct version.
 */
...
int fuse_readdir(const char* path, void* buf, fuse_fill_dir_t fill, off_t off, struct fuse_file_info* fi)
{
